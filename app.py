...
with st.sidebar:
    page = st.radio("View", ["Pick-Up Report (DD)", "Dashboard",
                             "Rate Plan Production", "Cancellations"], index=0,
                    help="Switch between the daily pick-up report, the owner "
                         "dashboard, the transient rate-plan production report, "
