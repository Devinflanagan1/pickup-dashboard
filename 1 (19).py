...
with st.sidebar:
    ...
    as_of = st.date_input(
        ...
        value=pcdc_asof,
        help="Auto-filled from the PCDC report's 'Generated On' timestamp (when the "
             "report was run) so it matches today. Override here if you want a "
...
if parts.get("pcdc_asof"):
    st.caption(f"📅 'Days Left' counts from the PCDC report's Generated On date: "
               f"**{pd.Timestamp(pcdc_asof):%b %d, %Y}**. "
