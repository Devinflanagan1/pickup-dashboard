...
window = fa.selectbox("Booking window",
                      ...
                      index=7,
                      help="Defaults to showing every date in your uploaded files, "
                           "past and future. 'All future dates' or any 'Next X days' "
                           "option will HIDE dates before your as-of date (negative "
                           "Days Left) — use the look-back option below if you pick "
                           "one of those and still want to see recent past dates too.")
